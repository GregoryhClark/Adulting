select user_id, reminder_template, first_instance_date, complete_by_date, frequencies.frequency, title, alert_date, completed, reminder_instances.is_deleted, reminder_instances.id from reminder_instances 
